...
|------------------|------------------|-------|
| **Windows** | `Documents\Ponder\Rules` | Uses system Documents folder |
| **macOS** | `~/Documents/Ponder/Rules` | Uses user Documents folder |
| **Linux/WSL** | `~/Documents/Ponder/Rules` | May fall back to `~/Ponder/Rules` on some systems |

> **Note for Linux/WSL users**: If you don't find your global rules in `~/Documents/Ponder/Rules`, check `~/Ponder/Rules` as the location may vary depending on your system configuration and whether the Documents directory exists.
